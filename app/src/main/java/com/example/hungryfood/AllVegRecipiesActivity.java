...
public class AllVegRecipiesActivity extends AppCompatActivity {
    ListView list_view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Veg Recipies");
    ...
    public void GetRecipeDetails() {
        db.collection("Recipies").whereEqualTo("category","Veg")
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            viewAllRecipiesAdapter = new ViewAllRecipiesAdapter(getRecipePojos, AllVegRecipiesActivity.this);
